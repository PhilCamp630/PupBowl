...
//     const playerImageUrl = document.getElementById("imageUrl").value;
...
//     const addedPlayer = await addNewplayer(playerObj);
//     if (addedPlayer) {
//       await fetchAllPlayers();
//       renderAllPlayers(state.players);
//     }
//   });
//   form.appendChild(addPlayer);
